...
public final class ActivitySecurityBinding implements ViewBinding {
  ...
  private ActivitySecurityBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnUnlock,
      @NonNull ImageView imgLock) {
  ...
  public static ActivitySecurityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySecurityBinding((ConstraintLayout) rootView, btnUnlock, imgLock);
    }
